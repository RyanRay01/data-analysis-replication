...
### Put results into a table and view as a histogram
```{r}
...
```{r}
histFI <- ggplot(data = results, aes(x = FIpercentvar)) +
  geom_histogram(binwidth = 5) + xlab("Percentage variance explained") +
  ylab("Number of properties") + xlim(c(0,25))
histFI
